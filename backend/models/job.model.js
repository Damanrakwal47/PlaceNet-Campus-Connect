...
const jobSchema = new mongoose.Schema({
  ...
  eligibility: {
    ...
    year: { type: Number, required: true }, // Replaced semester with year
    gap: { type: Number, required: true }, // Added gap field
    backlogs: { type: Number, required: true }, // Included backlogs
    tenthPercentage: { type: Number, required: true }, // Added 10th percentage
    twelfthPercentage: { type: Number, required: true }, // Added 12th percentage
  },
  salary: { type: Number },
