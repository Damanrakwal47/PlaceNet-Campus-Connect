...
const {
  UploadOfferLetter,
  DeleteOfferLetter,
} = require("../controllers/Student/offer-letter.controller.js");

const {
  AppliedToJob,
  CheckAlreadyApplied,
} = require("../controllers/Student/apply-job.controller.js");

const {
  UpdateJobStatus,
} = require("../controllers/Student/update-job-status.controller.js");

const {
  GetInternships,
  UpdateInternship,
  DeleteInternship,
} = require("../controllers/Student/internship.controller.js");

const {
  StudentDataYearBranchWise,
  NotifyStudentStatus,
} = require("../controllers/Student/student-data-for-admin.controller.js");
...
// Route to upload offer letter (protected)
router.post(
  "/upload-offer-letter",
...
// Route to delete offer letter (use DELETE method and protect it)
router.delete(
