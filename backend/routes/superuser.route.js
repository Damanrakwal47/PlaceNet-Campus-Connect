...
} = require("../controllers/SuperUser/user-management.controller.js");
// tpo methods
const {
  tpoUsers,
  tpoAddUsers,
  tpoDeleteUsers,
} = require("../controllers/SuperUser/user-tpo.controller.js");
// student methods
const {
  studentUsers,
  studentAddUsers,
  studentDeleteUsers,
  studentApprove,
} = require("../controllers/SuperUser/user-student.controller.js");
