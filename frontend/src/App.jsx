...
const ReportGenerator = lazy(() => import("./components/TPO/ReportGenerator.jsx"));
// Management pages
        ...
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['tpo_admin']} /></UserProvider>}>
              ...
              <Route element={<Layout header="Generate Report" />}>
  <Route path="/tpo/student-report" element={<ReportGenerator />} />
</Route>
            </Route>
