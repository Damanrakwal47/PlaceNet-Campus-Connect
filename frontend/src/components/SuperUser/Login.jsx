...
function LoginSuperUser() {
  document.title = 'PCC | Admin Login';
  ...
  >
    ...
    <div className="flex justify-center items-center flex-col">
      <Button 
        ...
        variant="primary" 
        disabled={isLoading}
        className="w-full bg-gradient-to-r from-blue-500 to-teal-500 text-white font-bold py-2 rounded-lg shadow-md hover:scale-105 transition-all"
      >
    ...
    {/* Footer */}
    <p className="text-muted text-center text-gray-400 mt-4">© PlaceNet Campus Connect 2024 - 25</p>
  </form>
</div>
